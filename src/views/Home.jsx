...
function Home (){
  return(
      ...
      <section className="container mt-5">
        <div className="row d-flex flex-column justify-content-center align-items-center">
          <div className="category text-center d-flex flex-column align-items-center">
            <h1 className="title-category">Ordering Process</h1>
            <p className="text-category">Please read the new ordering process below. Things may have changed since the last time you ordered from us.</p>
          </div>
        </div>
        <div className="row">
          <Howbuy/>
